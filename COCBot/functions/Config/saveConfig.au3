...
Func SaveConfig_600_28_DB()
	...
	_Ini_Add("attack", "DBKingWait", $g_iHeroWaitAttackNoBit[$DB][0] = 0 ? $eHeroNone : $eHeroKing)
	_Ini_Add("attack", "DBQueenWait", $g_iHeroWaitAttackNoBit[$DB][1] = 0 ? $eHeroNone : $eHeroQueen)
	_Ini_Add("attack", "DBWardenWait", $g_iHeroWaitAttackNoBit[$DB][2] = 0 ? $eHeroNone : $eHeroWarden)
...
Func SaveConfig_600_28_LB()
	...
	_Ini_Add("attack", "ABKingWait", $g_iHeroWaitAttackNoBit[$LB][0] = 0 ? $eHeroNone : $eHeroKing)
	_Ini_Add("attack", "ABQueenWait", $g_iHeroWaitAttackNoBit[$LB][1] = 0 ? $eHeroNone : $eHeroQueen)
	_Ini_Add("attack", "ABWardenWait", $g_iHeroWaitAttackNoBit[$LB][2] = 0 ? $eHeroNone : $eHeroWarden)
